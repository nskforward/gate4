...
const (
	Accounts_ListUserAccounts_FullMethodName = "/proto.Accounts/ListUserAccounts"
...
type AccountsClient interface {
	ListUserAccounts(ctx context.Context, in *UserID, opts ...grpc.CallOption) (*AccountList, error)
...
func (c *accountsClient) ListUserAccounts(ctx context.Context, in *UserID, opts ...grpc.CallOption) (*AccountList, error) {
...
type AccountsServer interface {
	ListUserAccounts(context.Context, *UserID) (*AccountList, error)
...
func (UnimplementedAccountsServer) ListUserAccounts(context.Context, *UserID) (*AccountList, error) {
...
func _Accounts_ListUserAccounts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountsServer).ListUserAccounts(ctx, req.(*UserID))
	}
