...
const (
	...
	Users_FindUserByID_FullMethodName = "/proto.Users/FindUserByID"
...
type UsersClient interface {
	...
	FindUserByID(ctx context.Context, in *UserID, opts ...grpc.CallOption) (*User, error)
...
func (c *usersClient) FindUserByID(ctx context.Context, in *UserID, opts ...grpc.CallOption) (*User, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(User)
	err := c.cc.Invoke(ctx, Users_FindUserByID_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUsersServer) FindUserByID(context.Context, *UserID) (*User, error) {
...
func _Users_FindUserByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserID)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UsersServer).FindUserByID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Users_FindUserByID_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UsersServer).FindUserByID(ctx, req.(*UserID))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Users_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Users_FindUserByID_Handler,
		},
		{
