...
func (c *Client) cmdHelp(context.Context) error {
	...
	commandInfo("subscribe quotes <symbol> <key>", "subscribe for quote stream", "gate4 subscribe quotes <symbol> <key>")
	commandInfo("positions <account_key>", "show list of account positions", "gate4 positions <key>")
